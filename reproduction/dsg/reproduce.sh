...
SETTING_ID="ffhq256_inpainting_ddim100_eta1_dsg_v1"
SETTING="${ROOT}/reproduction/dsg/settings/${SETTING_ID}.json"
...
"${PYTHON}" reproduction/visualize_inpainting.py \
  ...
  --run-dir "${ARTIFACT_ROOT}/runs/dsg/${SETTING_ID}/${RUN_ID}"
